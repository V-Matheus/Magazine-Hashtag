import { catalogo, salvarLocalStorage, lerLocalStorage } from "./utilizades";
...
function desenharProdutoNoCarrinho(idProduto) {
  ...
  <img src="./assets/img/${produto.imagem}.jpg" alt="Carrinho: ${
    produto.nome
  ...
  <div class="flex text-slate-950 items-end absolute bottom-0 right-2 text-lg">
    <button id="decrementar-produto-$${produto.id}" class="mr-2">-</button>
  ...
  document
    ...
    .addEventListener("click", () =>
      decrementarQuantidadeDoProduto(produto.id)
    );

  document
    .getElementById(`incrementar-produto-$${produto.id}`)
    .addEventListener("click", () =>
      incrementarQuantidadeDoProduto(produto.id)
    );
